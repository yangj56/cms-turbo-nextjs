  ...
  return (
    <footer className="flex w-full items-center justify-center bg-primary py-12 text-white">
      <div className="container">
        {/* Desktop Footer */}
        <div className="mb-8 grid grid-cols-2 gap-x-4 gap-y-20 md:grid-cols-4 lg:grid-cols-6">
          {/* Products Column */}
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about/near" className="hover:opacity-80">
                  Near
                </Link>
              </li>
              <li>
                <Link href="/about/honest-lighting" className="hover:opacity-80">
                  Honest Lighting
                </Link>
              </li>
              <li>
