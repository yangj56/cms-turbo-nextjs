...
export const Footer = ({ data }: { data: ProductCategory[] }): JSX.Element => {
	return (
		<footer className="flex w-full items-center justify-center bg-primary pt-4 pb-12 text-white">
			<div className="w-full p-4 md:p-16">
				...
				<div className="mb-8 grid grid-cols-1 gap-x-4 gap-y-20 p-4 sm:grid-cols-2 md:grid-cols-3 md:p-0 lg:grid-cols-6">
					...
					<div className="col-span-1">
						<h3 className="mb-8 font-normal text-md">Products</h3>
						<ul className="space-y-1">
							<li>
								<Link
									href="/collection-products"
									className="font-thin text-sm hover:opacity-80"
								>
									Shop All
								</Link>
							</li>
					...
					{/* Contact Us Column */}
					<div className="col-span-1">
						<h3 className="mb-8 font-normal text-md">Contact Us</h3>
						<ul className="space-y-2">
							<li>
								<span className="font-thin text-sm">
									Whatsapp us: +65 9727 1719
								</span>
							</li>
							<li>
								<span className="font-thin text-sm">
									Email us: support@near.sg
								</span>
							</li>
						</ul>
					</div>
					...
					<div className="col-span-1 flex flex-col items-start md:col-span-1 md:items-start lg:col-span-4 lg:items-end">
						<h3 className="mb-8 font-normal text-md">Follow Us</h3>
				...
				<div className="mt-8 border-white/20 border-t pt-8">
					<p className="font-bold text-sm">© Honest Lighting</p>
				</div>
			</div>
		</footer>
	);
